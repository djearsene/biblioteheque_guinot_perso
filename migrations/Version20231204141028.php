 ...
 */
final class Version20231204141028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document DROP photo');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD photo VARCHAR(500) DEFAULT NULL');
    }
}
